...
function App() {
  ...
  const allSkills = [
    ...
    { name: "Render", icon: "https://repository-images.githubusercontent.com/543813098/366e0eef-a3e8-4953-afc3-88c6e2ed954f", category: "tools", level: "Intermediate" },
